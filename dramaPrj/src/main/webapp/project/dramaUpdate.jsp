...
<link href="project/css/drama_update.css" rel="stylesheet"/>
<meta charset="UTF-8">
 ...
 -->
	...
	<div class="container ">
		<div class="row border-bottom"  >
			<h2 class="pageTitle col-11">수정페이지</h2>
			<form action="/dramaPrj/dramaDelete.do" method="post" class="col-1">
				<input type="hidden" value="${dramaDetail.dnum }" name = "dnum">
				<input type="submit" value="삭제" class="ddel_btn btn btn-danger">
			</form>
		</div>
		<form action="/dramaPrj/dramaUpdate.do" method="post">
			<div class="row g-0">
