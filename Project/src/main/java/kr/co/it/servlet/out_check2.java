...
/**
 * Servlet implementation class out_check2
 */
@WebServlet("/out_check2")
public class out_check2 extends HttpServlet {
		...
		UserDAO dao = UserDAO.getInstance();
			...
			if(user != null){
				...
				if(fId.equals(uId) && fPw.equals(uPw)){
					...
					RequestDispatcher dp = request.getRequestDispatcher("/member_out");
